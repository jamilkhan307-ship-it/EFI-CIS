...
export const FALLBACK_FORM_CONFIG: FormSectionConfig[] = [
  {
    sectionId: "A",
    ...
    fields: [
      ...
      { fieldId: "customerSample", fieldLabel: "Customer Sample", fieldType: "dropdown", isMandatory: true, isActive: true, isRestricted: false, isSystemLocked: false, helpText: "", displayOrder: 5, options: ["Yes", "No"] },
      { fieldId: "customerDrawing", fieldLabel: "Customer Drawing", fieldType: "dropdown", isMandatory: true, isActive: true, isRestricted: false, isSystemLocked: false, helpText: "", displayOrder: 6, options: ["Yes", "No"] },
  ...
  },
  {
    ...
    fields: [
      ...
      { fieldId: "apqpTimingPlan", fieldLabel: "APQP Timing Plan Required", fieldType: "dropdown", isMandatory: false, isActive: true, isRestricted: false, isSystemLocked: false, helpText: "", displayOrder: 2, options: ["Yes", "No"] },
  ...
  },
  {
    ...
    displayOrder: 5,
    fields: [
      { fieldId: "commonSharedTooling", fieldLabel: "Common / Shared Tooling", fieldType: "dropdown", isMandatory: false, isActive: true, isRestricted: false, isSystemLocked: false, helpText: "", displayOrder: 1, options: ["Yes", "No"] },
